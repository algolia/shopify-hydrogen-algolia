...
function sendConversion(params, sendEvent) {
  if (sendEvent) {
    window.aa('init', {
...
export function ProductForm() {
  ...
  const {options, setSelectedOption, selectedOptions, selectedVariant} =
    useProductOptions();
  const isAlgoliaConversion = params.has('queryID') && params.has('objectID');
        ...
        >
          ...
          >
            {isOutOfStock ? (
              ...
              <div
                aria-hidden="true"
                onClick={() => sendConversion(params, isAlgoliaConversion)}
              >
                <Text
                  as="span"
