/**
 * Algiolia InstantSearch component for both search & browse (collection page)
...
import {NumericMenu} from './NumericMenu.client';
...
export default function AlgoliaSearch(props) {
  ...
  const collection = props.collection; // Get collection name if the page is rendered as collection page
  return (
    <InstantSearch
    ...
    >
      ...
      <header className="header">
        {/* Render different content for search page and collection page */}
      ...
      {/* Send different search queries for search page and collection page */}
      {!collection ? (
        <Configure query={initialQuery} distinct clickAnalytics />
      ) : (
        <Configure
          query={initialQuery}
          ...
          <section className="container-filters">
            ...
            <div className="container-body">
              ...
              <NumericMenu
                ...
                items={[
                  {label: 'All'},
                  {label: 'Less than 300$', end: 300},
                  {label: 'Between 300$ - 600$', start: 300, end: 600},
                  {label: 'More than 600$', start: 600},
                ]}
              />
